...
def edit_employee():
    ...
    id_to_edit = simpledialog.askinteger("Edit Employee Data", "Enter employee ID:")  # Changed text here
    if id_to_edit:
        emp_info = employees.get(id_to_edit)
        if emp_info:
            edit_employee_window = tk.Toplevel(root)
            edit_employee_window.title(f"Edit Employee Data {id_to_edit}")  # Changed text here
...
staffing_menu.add_command(label="Edit Staffing Data", command=open_edit_staffing_window)  # Added "Edit Staffing Data"
